...
class DebateViewGroups(val minutes: Int = 60, val questions: Map<String, QuestionGroup> = mapOf(), val bus: Bus = Bus()) : DefaultView<DebateActivity> {
